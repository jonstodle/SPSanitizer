...
def send_mail(
    ...
    """Sends an email to the specified receivers using the Sykehuspartner Exchange server."""
    ...
    server = smtplib.SMTP("outlook.sykehuspartner.no", 587)
    server.starttls()
...
if __name__ == "__main__":
    ...
    send_mail(args.sender, args.receivers.split(","), args.subject, args.body, args.username, args.password)